...
def place(t,xmag,ymag,inside):
    ...
    for y in xrange(0, ymax):
        for x in xrange(0, xmax):
            append(inside,placements,x,y,t,xmax,ymax,[[0,1],[0,2],[1,0],[1,1],[2,0]])
            append(inside,placements,x,y,t,xmax,ymax,[[0,1],[1,0],[1,1],[2,-1],[2,0]])

            append(inside,placements,x,y,t,xmax,ymax,[[0,0],[0,1],[1,0],[1,1],[1,2]])
            append(inside,placements,x,y,t,xmax,ymax,[[0,1],[0,2],[0,3],[1,2],[1,3]])

            append(inside,placements,x,y,t,xmax,ymax,[[0,1],[1,0],[1,1],[1,2],[1,3]])
            append(inside,placements,x,y,t,xmax,ymax,[[0,0],[0,1],[0,2],[0,3],[1,2]])

            append(inside,placements,x,y,t,xmax,ymax,[[0,3],[1,-1],[1,0],[1,1],[1,2]])
            append(inside,placements,x,y,t,xmax,ymax,[[0,1],[0,2],[0,3],[0,4],[1,0]])

            append(inside,placements,x,y,t,xmax,ymax,[[0,0],[0,1],[1,-1],[1,0],[2,-2]])
            append(inside,placements,x,y,t,xmax,ymax,[[0,1],[1,-1],[1,0],[2,-2],[2,-1]])

            append(inside,placements,x,y,t,xmax,ymax,[[0,1],[0,2],[0,3],[1,-1],[1,0]])
            append(inside,placements,x,y,t,xmax,ymax,[[0,1],[0,2],[1,-2],[1,-1],[1,0]])
